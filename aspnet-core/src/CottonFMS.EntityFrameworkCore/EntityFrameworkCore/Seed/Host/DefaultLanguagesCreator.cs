...
namespace CottonFMS.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly CottonFMSDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = CottonFMSConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CottonFMSDbContext context)
        {
            _context = context;
        }
